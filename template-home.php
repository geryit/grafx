            ...
            <div class="imagebox">
                <div class="imagebox__full--linkbox"> <a href="">
                    <div class="imagebox__full">
                        ...
                        <div class="imagebox__full--image"> <img style="width:100%; height:100%" src="<?= get_template_directory_uri(); ?>/dist/img/home-imagebox/imagebox-full.png"></div>
                    </div>
                </a></div>
            </div>
            <div class="imagebox">
                <div class="imagebox__half">
                    ...
                    <img class="imagebox__half--image" src="<?= get_template_directory_uri(); ?>/dist/img/home-imagebox/imagebox-half1.png">
                </div>
                <div class="imagebox__half">
                    <div class="imagebox__half--link">VIEW CASE
                    </div>
                    ...
                    <img class="imagebox__half--image" src="<?= get_template_directory_uri(); ?>/dist/img/home-imagebox/imagebox-half2.png">
                </div>
                <div class="imagebox__half">
                    <div class="imagebox__half--link">VIEW CASE
                    </div>
                    ...
                    <img class="imagebox__half--image" src="<?= get_template_directory_uri(); ?>/dist/img/home-imagebox/imagebox-half3.png">
                </div>
                <div class="imagebox__half">
                    <div class="imagebox__half--link">VIEW CASE
                    </div>
                    ...
                    <img class="imagebox__half--image" src="<?= get_template_directory_uri(); ?>/dist/img/home-imagebox/imagebox-half4.png">
                </div>
            </div>
            <div class="clients">
                ...
                <div class="clients__list">
                    <div class="clients__item">
                        ...
                        <img class="clients__item--logo" src="<?= get_template_directory_uri(); ?>/dist/img/home-brand-logos/logo1.png">
                    </div>
                    <div class="clients__item">
                        <div class="clients__item--link">LEARN MORE
                        </div>
                        <img class="clients__item--logo" src="<?= get_template_directory_uri(); ?>/dist/img/home-brand-logos/logo2.png">
                    </div>
                    <div class="clients__item">
                        <div class="clients__item--link">LEARN MORE
                        </div>
                        <img class="clients__item--logo" src="<?= get_template_directory_uri(); ?>/dist/img/home-brand-logos/logo3.png">
                    </div>
                    <div class="clients__item">
                        <div class="clients__item--link">LEARN MORE
                        </div>
                        <img class="clients__item--logo" src="<?= get_template_directory_uri(); ?>/dist/img/home-brand-logos/logo4.png">
                    </div>
                    <div class="clients__item">
                        <div class="clients__item--link">LEARN MORE
                        </div>
                        <img class="clients__item--logo" src="<?= get_template_directory_uri(); ?>/dist/img/home-brand-logos/logo5.png">
                    </div>
                    <div class="clients__item">
                        <div class="clients__item--link">LEARN MORE
                        </div>
                        <img class="clients__item--logo" src="<?= get_template_directory_uri(); ?>/dist/img/home-brand-logos/logo6.png">
                    </div>
                    <div class="clients__item">
                        <div class="clients__item--link">LEARN MORE
                        </div>
                        <img class="clients__item--logo" src="<?= get_template_directory_uri(); ?>/dist/img/home-brand-logos/logo7.png">
                    </div>
                    <div class="clients__item">
                        <div class="clients__item--link">LEARN MORE
                        </div>
                        <img class="clients__item--logo" src="<?= get_template_directory_uri(); ?>/dist/img/home-brand-logos/logo8.png">
                    </div>
                    <div class="clients__item">
                        <div class="clients__item--link">LEARN MORE
                        </div>
                        <img class="clients__item--logo" src="<?= get_template_directory_uri(); ?>/dist/img/home-brand-logos/logo9.png">
                    </div>
                    <div class="clients__item">
                        <div class="clients__item--link">LEARN MORE
                        </div>
                        <img class="clients__item--logo" src="<?= get_template_directory_uri(); ?>/dist/img/home-brand-logos/logo10.png">
                    </div>
                    <div class="clients__item">
                        <div class="clients__item--link">LEARN MORE
                        </div>
                        <img class="clients__item--logo" src="<?= get_template_directory_uri(); ?>/dist/img/home-brand-logos/logo11.png">
                    </div>
                    <div class="clients__item">
                        <div class="clients__item--link">LEARN MORE
                        </div>
